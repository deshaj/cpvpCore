...
public class EventManager {
    ...
    public void openEvent() {
        ...
        broadcastMultiline(plugin.getConfigManager().getMessage("event-opened"));
    ...
    public void startEvent() {
        ...
        broadcastMultiline(plugin.getConfigManager().getMessage("event-started"));
    ...
    public void handleDeath(Player player) {
        ...
        if (eventData.getDiePosition() != null) {
            player.teleport(eventData.getDiePosition());
        }
    ...
    private void declareWinner() {
        ...
        if (!headMessages.isEmpty()) {
            ...
            broadcastMultiline(plugin.getConfigManager().getMessage("winner-announced")
    ...
    private void endEvent() {
        ...
        try {
            ...
            plugin.getLogger().warning("Error during border cleanup: " + e.getMessage());
        }
    ...
    public void cancelEvent() {
        ...
        broadcastMultiline(plugin.getConfigManager().getMessage("event-cancelled"));
    ...
    public void forceEndEvent() {
        ...
        if (participants.size() == 1) {
            ...
            broadcastMultiline(plugin.getConfigManager().getMessage("event-force-ended"));
    ...
    private void broadcastMultiline(String message) {
